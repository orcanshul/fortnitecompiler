fortnite compiler to compile uhhh?

Use the following:
Docker (Reccomended to self host containers of qdrant and the project itself, but you can customize it)
Python (:/)
Ollama (you can change this out with an OpenAI API key / Gemini Key / anything to win hackythings)
